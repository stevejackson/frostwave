...
namespace F2DUnitTests.Core
{
    ...
    public class DirectorTests : TestingGrounds.Game1
    {
        ...
        [Test]
        public void IsScreenFocusFailure()
        {
            Director.Initialize(this);

            Screen scr1 = new Screen();
            Director.AddScreen("vanilla", scr1);

            Screen scr2 = new Screen();
            Director.AddScreen("chocolate", scr2);

            Assert.IsFalse(Director.IsScreenFocus("vanilla"));
        }

        [Test]
        public void IsScreenFocusSuccess()
        {
            Director.Initialize(this);
            ...
            Assert.IsTrue(Director.IsScreenFocus("chocolate"));
        }
    }
}
