...
namespace FarseerGames.FarseerPhysics.Collisions {
    ...
    public class Geom : IEquatable<Geom>, IIsDisposable {
        ...
        private EventHandler<EventArgs> bodyOnDisposedEventHandler;
        private Body.OnChangeHandler bodyOnChangeHandler;

        public delegate bool CollisionHandlerDelegate(Geom geometry1, Geom geometry2, ContactList contactList);
        ...
        public void SetBody(Body body){
            this.body = body;          
            bodyOnChangeHandler = new Body.OnChangeHandler(body_OnChange);
            body.OnUpdate += bodyOnChangeHandler;

            bodyOnDisposedEventHandler = new EventHandler<EventArgs>(body_OnDisposed);
            body.OnDisposed += bodyOnDisposedEventHandler;
        ...
        protected virtual void Dispose(bool disposing) {
            ...
            if (!isDisposed) {
                if (disposing) {
                    ...
                    if(body!=null && bodyOnChangeHandler !=null){
                        body.OnUpdate -= bodyOnChangeHandler;
                        body.OnDisposed -= bodyOnDisposedEventHandler;
                    }
                };
