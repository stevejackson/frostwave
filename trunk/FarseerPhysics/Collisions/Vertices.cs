    ...
    public class Vertices : List<Vector2> {
        ...
        {            
            ...
            for (i = 0; i < Count; i++)
            {
                ...
                //Debug.WriteLine(i.ToString() + factor.ToString() + " -- " + this[i].ToString());
            }
            area *= 6.0f;
            factor = 1 / area;
            cx *= factor;
        ...
        public float CalculateMomentOfInertia() {
            if (this.Count == 0) { throw new ArgumentOutOfRangeException("vertexes"); }
            ...
            float a, b, c, d;
            Vector2 v1, v2;
            v1 = this[this.Count - 1];
            for (int index = 0; index < this.Count; index++, v1 = v2) {
                v2 = this[index];
        ...
        public void Translate(Vector2 vector) {
            for (int i = 0; i < this.Count; i++) {
                this[i] = Vector2.Subtract(this[i], vector);
            }
        }
