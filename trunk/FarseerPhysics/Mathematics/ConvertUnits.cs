...
namespace FarseerGames.FarseerPhysics.Mathematics {
    public class ConvertUnits {
        ...
        public static float ToSimUnits(float simUnits) {
            return simUnits * _simUnitsToDisplayUnitsRatio;
        }

        public static float ToSimUnits(double simUnits)
        {
            return (float)simUnits * _simUnitsToDisplayUnitsRatio;
        }

        public static float ToDisplayUnits(int displayUnits) {
            return (float)displayUnits * _displayUnitsToSimUnitsRatio;
        }

        public static float ToSimUnits(int simUnits) {
            return (float)simUnits * _simUnitsToDisplayUnitsRatio;
        }
