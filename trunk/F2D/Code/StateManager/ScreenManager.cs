...
namespace F2D.StateManager
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        public ScreenManager(Game game, GraphicsDeviceManager gfx)
            : base(game)
        {
            renderCells = false;
        ...
        protected override void LoadContent()
        {
            ...
            F2D.Management.Grid.LoadContent(content, @"Content\Graphics\bgCell");
        ...
        {
            F2D.StateManager.ScreenManager.SceneBatch.Begin(SpriteBlendMode.AlphaBlend,
